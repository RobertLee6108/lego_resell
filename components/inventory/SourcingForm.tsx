...
import { actionAddSourcingRecord } from "@/app/inventory/actions";
...
export function SourcingForm({ products }: SourcingFormProps) {
  const [, action, pending] = useActionState(
    async (_prev: null, formData: FormData) => {
      await actionAddSourcingRecord(formData);
      return null;
    },
    null,
  );
  ...
  return (
    ...
    >
      <h3 className="mb-4 text-base font-semibold text-zinc-800">소싱 기록 추가</h3>
